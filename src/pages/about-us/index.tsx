        ...
        <MainLayout>
            ...
            >
                <div className='w-full max-w-[800px] flex flex-col gap-[50px] px-4 lg:px-0 mx-auto'>
                    ...
                    <motion.div initial="offscreen" whileInView="onscreen" variants={fadeEntrance} className='w-full aspect-[16_/_5] flex justify-between items-center px-[clamp(20px,_10%,_80px)] relative'>
